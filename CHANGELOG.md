...
All notable changes to FreeVideoEditor. Weekly CalVer: `YYYY.MM.DD` = the Monday of the release week (Mon–Sun).
...
- Install FreeVideoEditor as a desktop app, with prompts when new versions ship
