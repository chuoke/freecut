...
FreeVideoEditor is a browser-based, local-first, multi-track video editor. It exists to
...
files). Success is an editor who would otherwise open Premiere choosing FreeVideoEditor
...
- **Consumer-cute editors** (CapCut, iMovie): playful mascots, rounded candy
  buttons, emoji, gamified flourishes. FreeVideoEditor is a pro tool, not a toy.
