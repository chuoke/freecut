...
const page = {
  order: 1.5,
  slug: 'concepts',
  title: 'How FreeVideoEditor Works',
  description:
  ...
  sections: [
      ...
      blocks: [
        {
          kind: 'list',
          items: [
            'FreeVideoEditor runs in your browser and stores everything in a **workspace folder** on your disk.',
            'Your original video and audio are **linked**, not copied or uploaded — FreeVideoEditor points to the files where they already live.',
    ...
    },
    {
      ...
      blocks: [
        {
          kind: 'paragraph',
          text: 'FreeVideoEditor has one primitive for **a timeline inside your project** — a composition. It shows up in two ways depending on how you use it.',
        },
        {
          kind: 'list',
          items: [
        ...
        },
        {
          kind: 'note',
          tone: 'info',
          text: 'A composition can contain other compositions, but never itself — FreeVideoEditor blocks circular references, so a compound clip can never end up nested inside its own contents.',
        },
      ],
    },
    {
      ...
      blocks: [
        {
          ...
          items: [
            ...
            'Source media can have a different frame rate than the project, so FreeVideoEditor converts source frames to project frames when you edit.',
          ],
        },
        {
          kind: 'note',
