# FreeVideoEditor Workspace

This folder is your FreeVideoEditor project workspace - the app's source of truth
...
`project.json` externally works; FreeVideoEditor picks up changes on next load.
